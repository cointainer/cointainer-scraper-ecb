...
def test_coins_2004():
    with open("tests/data/comm_2004.en.html", "rb") as f:
        coins = _get_two_euro_commemorative_coins(f.read(), "en", 2004)
...
def test_coins_2007():
    with open("tests/data/comm_2007.en.html", "rb") as f:
        coins = _get_two_euro_commemorative_coins(f.read(), "en", 2007)
...
def test_coins_2015():
    with open("tests/data/comm_2015.en.html", "rb") as f:
        coins = _get_two_euro_commemorative_coins(f.read(), "en", 2015)
...
def test_coins_2021():
    with open("tests/data/comm_2021.en.html", "rb") as f:
        coins = _get_two_euro_commemorative_coins(f.read(), "en", 2021)
