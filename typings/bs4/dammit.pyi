...
class EncodingDetector:
    ...
    def __init__(self, markup, known_definite_encodings: Iterable[str] | None = ..., is_html: bool = ..., exclude_encodings: list[str] | None = ..., user_encodings: list[str] | None = ..., override_encodings: list[str] | None = ...) -> None:
        ...
...
class UnicodeDammit:
    ...
    def __init__(self, markup, known_definite_encodings: list[str] | None = ..., smart_quotes_to: Literal["ascii", "xml", "html"] | None = ..., is_html: bool = ..., exclude_encodings: list[str] | None = ..., user_encodings: list[str] | None = ..., override_encodings: list[str] | None = ...) -> None:
        ...
