...
class PageElement:
    ...
    def setup(self, parent: Tag | None = ..., previous_element: PageElement | None = ..., next_element: PageElement | None = ..., previous_sibling: PageElement | None = ..., next_sibling: PageElement | None = ...) -> None:
        ...
    ...
    def find_next(self, name: _Strainable | SoupStrainer | None = ..., attrs: dict[str, _Strainable] | _Strainable = ..., text: _Strainable | None = ..., **kwargs: _Strainable) -> Tag | NavigableString | None:
        ...
    
    findNext = ...
    def find_all_next(self, name: _Strainable | SoupStrainer | None = ..., attrs: dict[str, _Strainable] | _Strainable = ..., text: _Strainable | None = ..., limit: int | None = ..., **kwargs: _Strainable) -> ResultSet[PageElement]:
        ...
    
    findAllNext = ...
    def find_next_sibling(self, name: _Strainable | SoupStrainer | None = ..., attrs: dict[str, _Strainable] | _Strainable = ..., text: _Strainable | None = ..., **kwargs: _Strainable) -> Tag | NavigableString | None:
        ...
    
    findNextSibling = ...
    def find_next_siblings(self, name: _Strainable | SoupStrainer | None = ..., attrs: dict[str, _Strainable] | _Strainable = ..., text: _Strainable | None = ..., limit: int | None = ..., **kwargs: _Strainable) -> ResultSet[PageElement]:
        ...
    
    findNextSiblings = ...
    fetchNextSiblings = ...
    def find_previous(self, name: _Strainable | SoupStrainer | None = ..., attrs: dict[str, _Strainable] | _Strainable = ..., text: _Strainable | None = ..., **kwargs: _Strainable) -> Tag | NavigableString | None:
        ...
    
    findPrevious = ...
    def find_all_previous(self, name: _Strainable | SoupStrainer | None = ..., attrs: dict[str, _Strainable] | _Strainable = ..., text: _Strainable | None = ..., limit: int | None = ..., **kwargs: _Strainable) -> ResultSet[PageElement]:
        ...
    
    findAllPrevious = ...
    fetchPrevious = ...
    def find_previous_sibling(self, name: _Strainable | SoupStrainer | None = ..., attrs: dict[str, _Strainable] | _Strainable = ..., text: _Strainable | None = ..., **kwargs: _Strainable) -> Tag | NavigableString | None:
        ...
    
    findPreviousSibling = ...
    def find_previous_siblings(self, name: _Strainable | SoupStrainer | None = ..., attrs: dict[str, _Strainable] | _Strainable = ..., text: _Strainable | None = ..., limit: int | None = ..., **kwargs: _Strainable) -> ResultSet[PageElement]:
        ...
    
    findPreviousSiblings = ...
    fetchPreviousSiblings = ...
    def find_parent(self, name: _Strainable | SoupStrainer | None = ..., attrs: dict[str, _Strainable] | _Strainable = ..., **kwargs: _Strainable) -> Tag | None:
        ...
    
    findParent = ...
    def find_parents(self, name: _Strainable | SoupStrainer | None = ..., attrs: dict[str, _Strainable] | _Strainable = ..., limit: int | None = ..., **kwargs: _Strainable) -> ResultSet[Tag]:
        ...
...
class Tag(PageElement):
    ...
    def __init__(self, parser: BeautifulSoup | None = ..., builder: TreeBuilder | None = ..., name: str | None = ..., namespace: str | None = ..., prefix: str | None = ..., attrs: dict[str, str] | None = ..., parent: Tag | None = ..., previous: PageElement | None = ..., is_xml: bool | None = ..., sourceline: int | None = ..., sourcepos: int | None = ..., can_be_empty_element: bool | None = ..., cdata_list_attributes: list[str] | None = ..., preserve_whitespace_tags: list[str] | None = ..., interesting_string_types: type[NavigableString] | tuple[type[NavigableString], ...] | None = ...) -> None:
        ...
    ...
    def encode(self, encoding: str = ..., indent_level: int | None = ..., formatter: str | Formatter = ..., errors: str = ...) -> bytes:
        ...
    ...
    def decode_contents(self, indent_level: int | None = ..., eventual_encoding: str = ..., formatter: str | Formatter = ...) -> str:
        ...
    ...
    def find(self, name: _Strainable | None = ..., attrs: dict[str, _Strainable] | _Strainable = ..., recursive: bool = ..., text: _Strainable | None = ..., **kwargs: _Strainable) -> Tag | NavigableString | None:
        ...
    
    findChild = ...
    def find_all(self, name: _Strainable | None = ..., attrs: dict[str, _Strainable] | _Strainable = ..., recursive: bool = ..., text: _Strainable | None = ..., limit: int | None = ..., **kwargs: _Strainable) -> ResultSet[Any]:
        ...
...
class SoupStrainer:
    ...
    def __init__(self, name: _Strainable | None = ..., attrs: dict[str, _Strainable] | _Strainable = ..., text: _Strainable | None = ..., **kwargs: _Strainable) -> None:
        ...
