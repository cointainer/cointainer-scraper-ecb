...
class Formatter(EntitySubstitution):
    ...
    def __init__(self, language: str | None = ..., entity_substitution: _EntitySubstitution | None = ..., void_element_close_prefix: str = ..., cdata_containing_tags: list[str] | None = ..., empty_attributes_are_booleans: bool = ...) -> None:
        ...
...
class HTMLFormatter(Formatter):
    ...
    def __init__(self, entity_substitution: _EntitySubstitution | None = ..., void_element_close_prefix: str = ..., cdata_containing_tags: list[str] | None = ...) -> None:
        ...
